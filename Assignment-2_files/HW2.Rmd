...
We can see that the highest frequency of estimated error for each group is zero, and we can see that in both sides of 0, there exists a similar distribution, overall it shows a normal distibution.
