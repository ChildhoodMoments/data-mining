...
```{r patrial effect of leed and energy star, echo = FALSE}
plot_1 = partialPlot(gbm_revenue, greenhouse_test, 'LEED', las=1)
plot_2 = partialPlot(gbm_revenue, greenhouse_test, 'Energystar', las=1)
```
...
```{r useful link partial effect for LEED and Energystar, echo=FALSE}
