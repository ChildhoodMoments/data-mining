...
\includegraphics{final_project_pdf_files/figure-latex/withou AIC-1.pdf}
...
\includegraphics{final_project_pdf_files/figure-latex/show result-1.pdf}
\includegraphics{final_project_pdf_files/figure-latex/show result-2.pdf}
...
\begin{center}\includegraphics{final_project_pdf_files/figure-latex/ROC curves combination-1} \end{center}

\begin{center}\includegraphics{final_project_pdf_files/figure-latex/ROC curves combination-2} \end{center}

\begin{center}\includegraphics{final_project_pdf_files/figure-latex/ROC curves combination-3} \end{center}
